  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-5 py-16 text-center">
      ...
      <div className="flex flex-col sm:flex-row gap-5 w-full max-w-xl">
        <Link
          to="/adultos"
          className="relative flex-1 texture-card rounded-2xl p-8 pt-9 text-left hover:-translate-y-1 transition-transform overflow-hidden"
        >
          ...
          <p className="text-ink/60 text-sm">Por nivel: A1/A2 · B1/B2 · C1/C2</p>
        </Link>
        ...
        >
          ...
          <p className="text-ink/60 text-sm">Por grupo: Primeros Pasos · Exploradores · Aventureros · Teens</p>
        </Link>
      </div>
    </div>
  )
